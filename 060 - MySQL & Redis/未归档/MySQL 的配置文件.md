...
![[../../020 - 附件文件夹/Pasted image 20230402002422.png]]
...
配置文件my.cnf通常会分成好几部分，如[client]，[mysqld], [mysql]等等。MySQL程序通常是读取与它同名的分段部分，例如服务器mysqld通常读取[mysqld]分段下的相关配置项。如果配置项位置不正确，该配置是不会生效的。详细文档我觉得可以参考这篇文章：[my.cnf详解](http://www.blogjava.net/hunter129/archive/2009/01/18/251744.html)
